	...
	public static Schedule getMutualAvailability(Schedule person1, Schedule person2) {
        ...
        // schedule.printSchedule();
         for (String day: person1Availability.keySet()) {
			  ArrayList<Integer> startTimes = person1Availability.get(day); 
			  
			 for (Integer time: startTimes) {
				  if(person2Availability.get(day).contains(time)) {
					  schedule.addAvailability(day, time);
				  }
